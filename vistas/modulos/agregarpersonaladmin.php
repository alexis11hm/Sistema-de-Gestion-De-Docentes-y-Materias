	      ...
	      <div class="modal-body">
		    ...
		    <div class="card-body register-card-body">
		      <p class="login-box-msg"><b>Registrar Personal</b></p>
		        ...
		        <div class="input-group mb-3">
		        	<input type="radio" class="form-control"  value="Hombre" name="sexoa">Hombre
		        ...
		        <div class="input-group mb-3">
		          <input type="text" class="form-control" placeholder="RFC" name="rfca" required="" onkeyup="" maxlength="30">
		          <div class="input-group-append">
		            <div class="input-group-text">
		              <span class="fas fa-square"></span>
		            </div>
		        ...
		        <div class="input-group mb-3">
		          <input type="text" class="form-control" placeholder="curp" name="curpa" required="" onkeyup="" maxlength="30">
		          <div class="input-group-append">
		            <div class="input-group-text">
		              <span class="fas fa-square"></span>
		            </div>
		        ...
		        <div class="input-group mb-3">
		          <input type="file" class="form-control" placeholder="Foto" name="fotoa"required="" onkeyup="" maxlength="30">
		          <div class="input-group-append">
		            <div class="input-group-text">
		              <span class="fas fa-square"></span>
		            </div>
